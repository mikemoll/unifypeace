$(function() {
   ...
   ========================================================================== */
    ...
    $('.counter').waypoint(function() {
        ...
        $('.total-number-1').animateNumber({
            number: 790200, //change value here
            numberStep: comma_separator_number_step
        }, 2000);

        $('.total-number-2').animateNumber({
            number: 23500, //change value here
            numberStep: comma_separator_number_step
        }, 2000);

        $('.total-number-3').animateNumber({
            number: 18050, //change value here
            numberStep: comma_separator_number_step
        }, 2000);

        $('.total-number-4').animateNumber({
            number: 9100, //change value here
            numberStep: comma_separator_number_step
        }, 2000);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.result != "success") {
                    ...
                    $('#mc-notification').hide().html('<span class="alert"><i class="fa fa-paper-plane"></i>' + message + '</span>').fadeIn("slow");
   ...
   ========================================================================== */
    ...
    $('#contact-form').validate({
        ...
        messages: {
            name: "<span class='text-left'><i class='fa fa-exclamation-triangle'></i>Please specify your name",
            email: {
